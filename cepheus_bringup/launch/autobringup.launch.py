...
def generate_launch_description():
    pkg_share = launch_ros.substitutions.FindPackageShare(package='cepheus_description').find('cepheus_description')
    ...
    firmware_dir=os.path.join(get_package_share_directory('cepheus_firmware'), 'launch')
    ...
    default_model_path = os.path.join(pkg_share, 'urdf/cepheus.xacro')
    default_rviz_config_path = os.path.join(get_package_share_directory('cepheus_description'), 'rviz/cepheus_navigation.rviz')
