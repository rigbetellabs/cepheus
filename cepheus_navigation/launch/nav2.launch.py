...
def generate_launch_description():
    ...
    params_directory= os.path.join(prefix_address, 'config', 'nav2_dwb_bt_params.yaml')
    map_directory = os.path.join(get_package_share_directory('cepheus_navigation'), 'maps','map6.yaml')
